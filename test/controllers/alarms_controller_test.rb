...
class AlarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post alarms_url, params: { alarm: { uplink_id: @alarm.uplink_id, value: @alarm.value } }
    end
  ...
  test "should update alarm" do
    patch alarm_url(@alarm), params: { alarm: { uplink_id: @alarm.uplink_id, value: @alarm.value } }
